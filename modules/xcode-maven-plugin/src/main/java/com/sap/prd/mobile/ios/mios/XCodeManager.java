...
class XCodeManager
{
        ...
        XCodeException
  {
    ...
    if (returnValue != 0) {
      throw new XCodeException("Could not execute xcodebuild for configuration " + ctx.getOptions().getOptions().get(Options.ManagedOption.CONFIGURATION.getOptionName()));
    }
  }
}
